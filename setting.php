...
public $tests;
   function  __construct(){
        $this->tests = array(
                ...
                array('name' => 'Traceroute', 'url' => "http://ipv6.he.net/certification/daily_trace.php",'htmloutput' => 'tracert.html', 'rawoutput' => 'traceraw.txt' ,'textareaname' => 'trtext','command' =>  "traceroute6 {ip}" ,'lastdone' => "" )
                );
